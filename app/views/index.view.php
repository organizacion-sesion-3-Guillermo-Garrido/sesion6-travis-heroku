        ...
        <div id="index-body">
            ...
            <div class="table-responsive">
                <table class="table text-center">
                    <thead>
                    <tr>
                        <td><a class="link active" href="#categoria1" data-toggle="tab">category
                                I</a></td>
                        <td><a class="link" href="#categoria2" data-toggle="tab">category II</a>
                        </td>
                        <td><a class="link" href="#categoria3" data-toggle="tab">category III</a>
                        </td>
                    </tr>
                    </thead>
                </table>
